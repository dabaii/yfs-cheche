...
export const ModalPortal = ({ modal, setModal, handleLogin, setJoinCount, joinCount, handleJoinByCount, tempAddress, setTempAddress, handleSaveAddress, user, addresses, selectedAddressId, setSelectedAddressId }) => {
